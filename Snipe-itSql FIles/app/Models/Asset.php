    ...
    */
    ...
    protected $rules = [
       ...
       'asset_tag'         => ['required', 'min:1', 'max:255', 'unique_undeleted:assets,asset_tag', 'not_array'],
        ...
        'last_checkout'     => ['nullable', 'mssql_datetime'],
'last_checkin'      => ['nullable', 'mssql_datetime'],
'expected_checkin'  => ['nullable', 'mssql_date'],
'last_audit_date'   => ['nullable', 'mssql_datetime'],
'next_audit_date'   => ['nullable', 'mssql_date'],
